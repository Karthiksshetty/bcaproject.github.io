...
<body class="bg-light">
  ...
  <?php
    ...
    $room_res = select("SELECT * FROM `rooms` WHERE (`id`=? AND `quantity`>0 AND `status`=?) AND `removed`=?",[$data['id'],1,0],'iii');
    ...
    <div class="row">
      ...
      <div class="col-lg-7 col-md-12 px-4 ">
        <div id="roomCarousel" class="carousel slide" data-bs-ride="carousel">
          <div class="carousel-inner swiper swiper-container">
            <?php
      ...
      <div class="col-lg-5 col-md-12 px-4">
        ...
        <div class="card mb-4 border-e shadow-sm rounded-3"> 
          <div class="card-body">
            <?php
              ...
              if(!$settings_r['shutdown']){
                $book_btn = "<a href='TxnTest.php#$room_data[id]' class='btn w-100 text-white custom-bg shadow-none mb-1'>Book Now</a>";
              }
