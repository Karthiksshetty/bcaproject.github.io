...
<div class="my-5 px-4">
  ...
  On behalf of The Indian Hotels Company Limited (IHCL), we would like to 
  assure you that the health <br>and safety of our guests and associates  is our utmost priority.
  </p>
</div>
  ...
  <div class="row">
    ...
    <div class="col-lg-6 col-md-6 mb-5 px-4">
      <div class="bg-white rounded shadow p-4">
        ...
        <a href="mailto: ask.ajithpai51@gmail.com" class="d-inline-block text-decoration-none text-dark">
      ...
      <div class="bg-white rounded shadow p-4">
        <form method="POST">
          ...
          <div class="mt-3">
            ...
            <input name="email" required type="email" class="form-control shadow-none" required>
          </div>
          <div class="mt-3">
